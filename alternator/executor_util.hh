...
// GSI/LSI view for materialized-view correctness. For base tables (which
// never have spurious clustering columns) and for schemas without the
// NUMBER_OF_NON_SPURIOUS_USER_SPECIFIED_RANGE_KEYS_TAG_KEY tag (e.g., LSIs,
...
uint32_t genuine_range_key_count(const schema&, const std::map<sstring, sstring>* tags);
